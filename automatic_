...
install_euphoria() {
    ...
    echo "✅ Euphoria theme installed!"
}

# Function: Install MC Plugin Addon
install_mcplugins() {
    echo "🛠️ Installing MC Plugin Addon..."
    apt install wget -y
    cd /var/www/pterodactyl || { echo "❌ Pterodactyl not found!"; exit 1; }
...
install_subdomain() {
    ...
    echo "✅ Subdomain Addon installed!"
}


# Function: Install Resource Manager
install_resource_manager() {
    ...
    echo "✅ Resource Manager installed!"
}

# Function: Install Pull Files
install_pull_files() {
    echo "📂 Installing Pull Files..."
    apt install wget -y
    cd /var/www/pterodactyl || { echo "❌ Pterodactyl not found!"; exit 1; }
    ...
    echo "✅ Pull Files installed!"
}

# Function: Install Player Manager
...
while true; do
    ...
    echo "6) Subdomain(blueprint)"
    echo "7) Resource Manager (blueprint)"
    echo "8) Pull Files (blueprint)"
    echo "9) Player Manager (blueprint)"
    echo "10) Exit"
    echo "==============================="
    ...
    case $choice in
        ...
        5) install_revix ;;
        6) install_subdomain ;;
        7) install_resource_manager ;;
        8) install_pull_files ;;
        9) install_player_manager ;;
